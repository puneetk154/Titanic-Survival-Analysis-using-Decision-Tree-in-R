...
train <- read.csv('C:/Users/Puneet Kishore/OneDrive/Desktop/Imarticus - R/train.csv')
test <- read.csv('C:/Users/Puneet Kishore/OneDrive/Desktop/Imarticus - R/test.csv')
...
write.csv(result, file = "C:/Users/Puneet Kishore/OneDrive/Desktop/Imarticus - R/result.csv", row.names = F)
